...
<?php //begin.Contextual Alternatives ?>
<div class="row clearfix">
	<div class="col-lg-12 col-md-12 col-sm-12">
		<div class="card">
			<div class="header">
...
<?php //end.Contextual Alternatives ?>
	...
	<div class="col-lg-12 col-md-12 col-sm-12">
		<div class="card">
			...
			<div class="body">
				...
				<div class="progress m-b-10">
					<div class="progress-bar bg-blue-grey progress-bar-striped" role="progressbar" aria-valuenow="32" aria-valuemin="0" aria-valuemax="100"
