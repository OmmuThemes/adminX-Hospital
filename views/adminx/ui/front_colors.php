...
<div class="row clearfix">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="card">
			<div class="header">
				<h2> MATERIAL DESIGN Gradient COLORS <small>Gradient Color</small> </h2>
			...
			<div class="body">
				<div class="clearfix row">
					<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3">
						<div class="demo-color-box g-bg-blue">
							<div class="color-name">Blue</div>
							<div class="color-code">1. #00adef  2. #0094da</div>
							<div class="color-class-name">g-bg-blue</div>
						</div>
					</div>
					<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3">
						<div class="demo-color-box g-bg-cyan">
							<div class="color-name">Cyan</div>
							<div class="color-code">1. #49cdd0  2. #45e5c3</div>
							<div class="color-class-name">g-bg-cyan</div>
						</div>
					</div>
					<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3">
						<div class="demo-color-box g-bg-blush2">
							<div class="color-name">Blush</div>
							<div class="color-code">1. #dd5e89  2. #f7bb97</div>
							<div class="color-class-name">g-bg-blush2</div>
						</div>
					</div>
					<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3">
						<div class="demo-color-box g-bg-purple">
							<div class="color-name">Purple</div>
							<div class="color-code">1. #8f78db  2. #ab9ae5</div>
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="card">
			<div class="header">
				<h2> MATERIAL DESIGN COLORS <small> Taken by Google's Material Design Color page which link is <a href="https://material.google.com/style/color.html#color-color-palette" target="_blank" title="Google's Material Design Color">material.google.com/style/color.html#color-color-palette</a> </small> </h2>
				<ul class="header-dropdown m-r--5">
					<li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i class="zmdi zmdi-more-vert"></i> </a>
						<ul class="dropdown-menu pull-right">
							<li><a href="javascript:void(0);">Action</a></li>
